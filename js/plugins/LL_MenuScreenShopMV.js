...
/*:
 * @target MV
 * @plugindesc Display standing pictures on the shop screen.
 ...
 *
 * Automatically displays the actor’s standing picture
 * when equipment is selected on the shop purchase screen.
 * * Configure the standing picture list in "LL_MenuScreenBaseMV".
 *
 * Actor Standing Picture Position:
 *   Actor standing pictures are shown at X/Y set in LL_MenuScreenBaseMV.
 *   (If linked with the battle plugin, the battle standing X/Y is used.)
 *   Adjust position with "Picture X" and "Picture Y" settings below.
 *
 * Shop Clerk Display:
 *   Clerk standing picture and dialogue can be set in "Shop Clerk List".
 *   (You can configure picture only, text only, or just a background.)
 *   Use the "Clerk Variable" to switch clerks per shop.
 *
 * If item categories are extended by other plugins:
 *   Enable "Show categories in default width" to avoid conflicts.
 *   Place "LL_MenuScreenShopMV" below other plugins if needed.
 *
 * No plugin commands.
 *
 * Terms of use:
 ...
 *
 * @param actorSettings
 * @text Actor Picture Settings
 * @desc *This parameter is unused
 *
 * @param shopWindowPictureX
 * @text Picture X
 * @desc Adjust actor standing picture X position. (Default: 0)
 ...
 * @text Picture Y
 * @desc Adjust actor standing picture Y position. (Default: 0)
 ...
 *
 * @param shopSettings
 * @text Clerk Picture Settings
 * @desc *This parameter is unused
 *
 * @param shopLists
 * @text Shop Clerk List
 * @desc Define the list of clerks to display in shops.
 * @default []
 ...
 * @text Clerk Variable
 * @desc Variable ID that selects the clerk setting.
 * Clerk defined by this variable number will be used.
 * @type variable
 * @parent shopSettings
 *
 ...
 * @desc Adjust message window X position.
 * Positive = right, Negative = left.
 * @default 0
 * @min -9999
 * @max 9999
 ...
 * @desc Adjust message window Y position.
 * Positive = down, Negative = up.
 * @default 0
 * @min -9999
 * @max 9999
 ...
 * @text Window Width
 * @desc Width of the message window. Enter number or script.
 ...
 * @text Window Rows
 * @desc Number of rows for the message window height.
 * @default 4
 * @type number
 * @parent shopMessageWindowSettings
 *
 * @param itemCategoryWindowDefault
 * @text Show Categories in Default Width
 * @desc Do not adjust category window width in sell scene.
 * Use this to avoid conflicts with other plugins.
 * (Normally keep this OFF.)
 * @default false
 * @type boolean
 */
 ...
 * @param number
 * @text Number
 * @desc The number used by Clerk Variable to call this clerk.
 * Must be unique.
 * @max 2000
 * @min 1
 * @type number
 ...
 * @text Clerk Picture
 * @desc Image file used for the clerk’s standing picture.
 * Optional.
 * @dir img/pictures
 * @type file
 * @require 1
 ...
 * @text Clerk Picture (Thanks)
 * @desc Image to switch to after purchase/sell completion.
 * Optional (defaults to normal picture if not set).
 * @dir img/pictures
 * @type file
 * @require 1
 *
 ...
 * @text Shop Message
 * @desc Message shown when shop scene starts.
 * Optional.
 * @type note
 *
 * @param buyMessage
 * @text Buy Message
 * @desc Message shown in purchase scene.
 * Optional.
 * @type note
 *
 * @param sellMessage
 * @text Sell Message
 * @desc Message shown in sell scene.
 * Optional.
 * @type note
 *
 * @param thanksMessage
 * @text Thanks Message
 * @desc Message shown after purchase/sell completion.
 * Optional.
 * @type note
 *
 * @param backgroundImage
 * @text Background Image
 * @desc Select background image to display if desired.
 * @dir img/pictures
 * @type file
 * @require 1
 */
