...
/*:
 * @target MV
 * @plugindesc Display info messages as pop-up windows.
 * @author Lulu's Church
 * @url https://nine-yusha.com/plugin-infowindow/
 *
 * @help LL_InfoPopupWIndowMV.js
 *
 * Displays info messages as pop-up windows.
 * Can be used for item acquisition messages or event notifications.
 * Execute plugin commands to display the window.
 *
 * Plugin Commands:
 *   LL_InfoPopupWIndowMV showWindow [Text] [Duration] [X] [Y] [Background]
 *     Text: Control characters supported. Multiple lines not allowed.
 *     Duration: Display time (in frames, 1/60 sec). Use -1 for continuous display.
 *     X/Y: Enter "auto" to automatically center.
 *     Background: 0=Window, 1=Dim, 2=Transparent
 *
 *   LL_InfoPopupWIndowMV hideWindow
 *     Hides the currently displayed info message.
 *
 *   [Examples]
 *   LL_InfoPopupWIndowMV showWindow Enter your message here 180 0 60 0
 *   LL_InfoPopupWIndowMV showWindow Enter your message here 180 auto auto 0
 *
 * Terms of use:
