...
/*:
 * @target MV
 * @plugindesc Displays a splash screen.
 * @author Lulu's Church
 * @url https://nine-yusha.com/plugin/
 *
 * @help LL_SprashScreenMV.js
 *
 * Displays splash screens.
 * Multiple splash screens can be set.
 * They can be skipped with the confirm key or mouse click.
 * Jingle ME playback is also supported.
 * (v1.1.0: Jingle ME can now be set per image)
 *
 ...
 * @param splashImages
 * @text Image List
 * @desc List of images to display as splash screens.
 ...
 * @desc Hide splash screen during test play.
 * @type boolean
 * @default false
 *
 ...
 * @param meName
 * @text ME
 * @desc Select the ME file to play.
 * @dir audio/me
 * @type file
 * @require 1
 ...
 * @desc Select the image file to display.
 * @dir img/system
 * @type file
 * @require 1
 *
 * @param fadeTime
 * @text Fade Time
 * @desc Duration of fade-in/out effect.
 * @default 60
 * @min 0
 * @max 999
 * @type number
 ...
 * @param waitTime
 * @text Display Time
 * @desc Duration of display after fade-in.
 * @default 60
 * @min 0
 * @max 999
 * @type number
 ...
 *
 * @param meTiming
 * @text Playback Timing
 * @desc Select when to play the ME.
 * @type select
 * @default before
 * @option Before Fade-In
 * @value before
 * @option After Fade-In
 * @value after
 * @parent jingleSettings
 */
